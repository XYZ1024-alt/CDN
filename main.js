new Vue({
  ...
  methods: {
    ...
    shareToQQ() {
      window.open(`http://connect.qq.com/widget/shareqq/index.html?url=${this.url}&sharesource=qzone&summary=XYZ1024' Blog&desc=XYZ1024' Blog`, '_blank', 'width=615,height=505')
    },
    /*shareToWeibo() {
